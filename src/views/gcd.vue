...
@font-face {
  ...
  font-weight: 400;
  font-display: swap;
  src: url(https://fonts.gstatic.com/s/barlow/v5/7cHpv4kjgoGqM7E_DMs9.eot);
}
@font-face {
  ...
  font-weight: 400;
  font-display: swap;
  src: url(https://fonts.gstatic.com/s/barlowcondensed/v5/HTx3L3I-JCGChYJ8VI-L6OO_au7B6xHT3g.eot);
}
#canvas {
  .about {
    position: fixed;
  ...
  .wrapper .container .circle:before {
    ...
    width: 800px;
    height: 800px;
    background-color: rgba(156, 208, 207, 0.8);

    border-radius: 100%;
    top: 50%;
    left: 50%;
    transform: translate(-50%, -50%);
    box-shadow: inset 5px 20px 40px rgba(121, 151, 149, 0.25),
      inset 5px 0px 5px rgba(121, 151, 149, 0.3),
      inset 5px 5px 20px rgba(121, 151, 149, 0.25),
  ...
  .wrapper .container .one .content:before {
    ...
    background-color: rgba(35, 123, 141, 0.6);

    border-radius: 100%;
    box-shadow: inset 5px 20px 40px rgba(51, 89, 95, 0.25),
      inset 5px 0px 5px rgba(51, 89, 95, 0.3),
      inset 5px 5px 20px rgba(51, 89, 95, 0.25),
      2px 2px 5px rgba(255, 255, 255, 0.2);
  ...
  .wrapper .container .one .content .piece {
    background: linear-gradient(
      90deg,
      rgba(250, 255, 255, 0.7) 13.7%,
      rgba(250, 255, 255, 0.7) 94.65%
    );
  }
  ...
  .wave {
    background: url(https://www.jq22.com/newjs/wave.svg) repeat-x;
    position: absolute;
    top: -198px;
    width: 6400px;
    height: 198px;
